...
import { delay, retryWhen, repeatWhen, tap, take } from 'rxjs/operators';
...
export class AppComponent implements OnInit {
  ...
  private beepSubscription: Subscription;
  ...
  initBeep() {
    ...
    this.beepSubscription = interval(1000).pipe(take(100)).subscribe(() => {
      beepSound.play()
    })
  }

  stopBeeping() {
    if (this.beepSubscription) {
